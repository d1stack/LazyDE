# lazyde-web: Python 3.12 + Node 22
# ---------------------------------------------------------------------
# Full-stack web development image (Python, JS/TS, HTML, CSS, Vue)
# layered on top of lazyde-base.
#
# Build:
#   podman build -f web/python3.12-node22.dockerfile \
#                -t lazyde-web:python3.12-node22 .
#
# Run:
#   podman run --rm -it -v "$PWD:/mnt/volume" lazyde-web:python3.12-node22
