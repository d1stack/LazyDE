# lazyde-web: Python 3.13 + Node 22
# ---------------------------------------------------------------------
# Full-stack web development image (Python, JS/TS, HTML, CSS, Vue)
# layered on top of lazyde-base.
#
# Build:
#   podman build -f web/python3.13-node22.dockerfile \
#                -t lazyde-web:python3.13-node22 .
#
# Run:
#   podman run --rm -it -v "$PWD:/mnt/volume" lazyde-web:python3.13-node22
...
# ---------------------------------------------------------------------
# 1. Python 3.13 + pip + build deps
# ---------------------------------------------------------------------
COPY --from=python:3.13-slim /usr/local /usr/local
