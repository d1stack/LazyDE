# lazyde-web: PHP 8.4 + Node 24
# ---------------------------------------------------------------------
# Full-stack web development image (PHP, JS/TS, HTML, CSS, Vue) layered
# on top of lazyde-base.
#
# Build:
#   podman build -f web/php8.4-node24.dockerfile \
#                -t lazyde-web:php8.4-node24 .
#
# Run:
#   podman run --rm -it -v "$PWD:/mnt/volume" lazyde-web:php8.4-node24
