# lazyde-web: PHP 8.3 + Node 20
# ---------------------------------------------------------------------
# Full-stack web development image (PHP, JS/TS, HTML, CSS, Vue) layered
# on top of lazyde-base.
#
# Build:
#   podman build -f web/php8.3-node20.dockerfile \
#                -t lazyde-web:php8.3-node20 .
#
# Run:
#   podman run --rm -it -v "$PWD:/mnt/volume" lazyde-web:php8.3-node20
